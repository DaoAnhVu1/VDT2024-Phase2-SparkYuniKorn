...
interface PartitionManagementProps {
    setPartition: React.Dispatch<React.SetStateAction<any>>; // Set type for setPartition
    partitions: Array<{ name: string }>; // Define the shape of partitions as an array of objects with name property
    selectedPartition: { name: string } | null; // Set selectedPartition as an object or null
}
